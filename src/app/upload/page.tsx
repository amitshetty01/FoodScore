        ...
        <div className="mb-10">
          <div className="rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
            ...
            <p className="mt-4 max-w-2xl text-sm leading-6 text-zinc-500 dark:text-zinc-400">
              If the product is not found in our database, upload package photos. We’ll use OCR to extract nutrition and ingredient information, then generate a score and confidence tier.
            </p>
          </div>
        </div>
