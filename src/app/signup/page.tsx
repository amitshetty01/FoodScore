      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass rounded-3xl p-8 shadow-xl shadow-black/5">
          <button
            ...
            className="w-full h-11 glass border border-zinc-200 dark:border-zinc-700 rounded-xl flex items-center justify-center gap-3 text-sm font-medium text-zinc-700 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors mb-6"
          >
